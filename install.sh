#!/bin/bash
# Instalação automatizada para Debian/Ubuntu
sudo apt update && sudo apt upgrade -y
sudo apt install -y python3-venv tor

# Configura diretório
sudo mkdir -p /opt/apps/omonitor/{data,logs}
sudo chown -R $USER:$USER /opt/apps/omonitor
